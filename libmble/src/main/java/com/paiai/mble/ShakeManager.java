...
public class ShakeManager implements SensorEventListener {
    ...
    public void start() {
        ...
        if (sensorManager == null) {
            LogUtils.e(TAG, "sensorManager error");
            return;
        }
        // 获得重力传感器
        ...
        // 注册
        if (sensor == null) {
            LogUtils.e(TAG, "sensor error");
            return;
        }
        sensorManager.registerListener(this, sensor, SensorManager.SENSOR_DELAY_NORMAL);
        LogUtils.e(TAG, "ShakeManager,start");
    }

    // 停止检测
    public void stop() {
        sensorManager.unregisterListener(this);
        LogUtils.e(TAG, "ShakeManager,stop");
    }
...
//		LogUtils.i("ShakeManager", "onSensorChanged");
        // 现在检测时间
